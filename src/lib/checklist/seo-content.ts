export const checklistSeoContent = {
  en: {
    ...
    faqs: [
      ...
      {
        question: "Can I download this declutter checklist as a PDF?",
        answer:
          "Yes. Open any room checklist and use the Download PDF button, it uses your browser's print dialog to save a clean, checkbox-ready PDF you can print or fill in by hand, with your current progress already checked off.",
      },
    ],
  },
  zh: {
    ...
    faqs: [
      ...
      {
        question: "这份断舍离清单支持下载 PDF 吗？",
        answer:
          "支持。打开任意一个房间的清单页面，点击“下载 PDF”按钮即可，它会调用浏览器自带的打印功能，生成一份干净、可勾选的 PDF，方便打印出来手动填写，当前已完成的进度也会保留。",
      },
    ],
  },
  ja: {
    ...
    faqs: [
      ...
      {
        question: "この断捨離チェックリストはPDFでダウンロードできますか？",
        answer:
          "できます。各部屋のチェックリストページにある「PDFをダウンロード」ボタンを押すと、ブラウザの印刷機能を使ってチェック欄付きのきれいなPDFを保存できます。印刷して手書きでチェックすることもでき、現在の進捗もそのまま反映されます。",
      },
    ],
  },
  es: {
