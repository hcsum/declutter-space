...
export class BrevoAdapter {
  ...
  async sendVerificationEmail(email: string, token: string) {
    ...
    sendSmtpEmail.htmlContent = `<p>You are one step away from completing your registration. Click <a href="${process.env.SITE_URL}/verify-email?token=${token}">here</a> to verify your email.</p>`;
    sendSmtpEmail.sender = sender;
    sendSmtpEmail.to = [to];
    sendSmtpEmail.replyTo = sender;
