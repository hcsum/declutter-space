...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      heroSubtitle:
        "sentimental items の片付けが難しいのは、量が多いからではなく、1つ1つに感情が結びついているからです。罪悪感、忘れてしまう不安、人からどう見られるかへの怖さ。このガイドでは、記憶を物に閉じ込めず、自分の中に残したまま進めるためのゆっくりした手順を紹介します。",
      ...
      emotionBody:
        "r/declutter で何度も共有される言葉に、『息子を捨てたのではなく、息子の持ち物の一部を手放しただけ』というものがあります。これが思い出の品を片付けるときの中心的な reframe です。記憶はあなたのものです。シャツやカードやマグカップが抱えているのではありません。物は手放せても、記憶は一緒に消えません。むしろ手放せるということは、大切だったものがすでに自分の中に根づいている証拠です。",
      permissionTitle: "自分に許していいこと（permission list）",
      permissionIntro:
      ...
      permissionItems: [
        ...
        "いったん保留していい。保留は永久保存ではなく、maybe box に入れて30〜90日後に見直せばいい",
      ],
      inheritedTitle: "受け継いだ物についての補足",
      inheritedBody:
        "親や近しい家族から受け継いだ belongings は、思い出の品の中でも特に重いカテゴリーです。自分の悲しみに加えて、『自分が代わりに決めてはいけないのでは』という感覚も乗ってきます。役に立つ問いは、『私がこの箱の前を通るたび重くなり、クローゼットも開けられず、収納にお金まで払っていると知ったら、あの人はそれを望むだろうか？』です。多くの人にとって、正直な答えはノーです。その答えが、動き始める許可になります。ほかの家族にも思い入れがありそうなら一度だけ声をかけましょう。ただし『みんなが決めるまで待つ』を永久保管にしないこと。期限を決め、そこまでに引き取り手がいなければ、自分で扱ってよい物です。",
      ...
      quickResetSteps: [
        ...
        "決められない物は写真を撮って maybe box に入れ、30〜90日後に見直す",
      ],
      faqTitle: "よくある質問",
      faqs: [
  ...
  if (locale === "zh") {
    return {
      ...
      description:
        "学习如何分步整理纪念物、纪念品和遗物。包含 7 步框架、permission list、继承物品的特殊处理，以及面对决策疲劳时的小招。",
      eyebrow: "Sentimental Items Guide",
      heroTitle: "如何整理情感物品（不带负罪感）",
      heroSubtitle:
        "Decluttering sentimental items 比其他类别都难，不是因为东西多，而是因为每一件都连着情绪——愧疚、害怕忘记、害怕被别人评价。这份指南给你一套可以慢慢走的流程，让记忆留在你身上，不再都被绑在物品上。",
      introTitle: "为什么 sentimental items 比其他杂物难",
      introBody:
        "厨房杂物你可以一抽屉一抽屉过，扔起来不疼。但情感物品的每一件都自带 \"如果我扔了，是不是就背叛了那段感情/那个人\" 的句子。这种 sentimental clutter 不是物品问题，是情绪问题。所以解决它的顺序也不一样：先处理情绪，再决定物品。把对的人换到对的位置后，整理本身反而是最简单的一步。",
      ...
      steps: [
        ...
        ["2. 拍下来，再决定", "Photograph before you decide。一张高清照片可以承载视觉记忆的 80% 以上。物品离开后你随时能看到它的样子，而它不再每天占用衣柜或储物间。这个动作能让 \"我会忘记\" 的恐惧消解大半。"],
        ["3. 问：这个物品现在为谁服务", "如果它的存在是为了 \"以防那个人哪天来看时看到\"——那它服务的不是你。如果是为了 \"想到 ta 的时候有东西可以拿\"——那它真的为你服务。前者可以放手，后者值得留下。"],
        ["4. 在一类东西里，只留 1-2 件最有重量的", "一柜子高中年鉴可以缩成 1 本你最常翻的。一抽屉前任送的卡片可以变成 2-3 张最重要的。整理 sentimental items 的关键不是保留所有，而是给最重要的那一两件一个清晰的位置。"],
        ["5. 放手时用 \"传递\"，不用 \"丢弃\"", "Reframe 是这一步的核心。\"我把它送给会用到的人\"、\"我把它捐给需要它的家庭\"——这些动作让物品继续活着，而不是终结。Reddit 上很多人提到，看到自己捐的东西出现在二手店或别人身上时，比一直藏着它要好得多。"],
        ["6. 让留下的那件真的活在你的生活里", "保留的物品如果继续躺在箱子里，你只是把焦虑换了位置。把保留的那一两件放到能看到、能用到的位置——挂出来、用起来、放在书架而不是地下室。物品的价值在被看到，不在被收藏。"],
        ["7. 建立一个节律，别再让 sentimental clutter 重新堆积", "每年一次、或者每次搬家、每次重大生活变动后，过一次这套流程。Sentimental items 会自然累积，关键是不要让它累积到 \"动都不敢动\" 的程度。"],
      ],
      ...
      emotionBody:
        "Reddit 上有一句被反复引用的话：\"我没有扔掉我去世的儿子，我只是放手了他的一部分东西。\" Sentimental decluttering 的核心 reframe 就是这个——记忆是你的，不是那件衣服、那张卡片、那只杯子的。物品可以走，记忆不会走。能够放手物品，反而说明你已经把它内化了。",
      permissionTitle: "你可以允许自己的事（permission list）",
      permissionIntro:
        "整理 sentimental items 时，绝大多数人卡住的不是 \"不知道怎么扔\"，而是 \"觉得自己没资格扔\"。下面这些都是允许的：",
      permissionItems: [
        "可以放手你爱的人送的东西",
        "可以只留一件，不留全部",
        "可以拍下来再让物品离开",
        ...
        "可以暂停。暂停不等于永远保留——把不确定的装进 maybe box，30-90 天后再决定",
      ],
      inheritedTitle: "继承物品的特殊处理",
      inheritedBody:
        "继承父母或亲人的物品（inherited items）是最重的一类。除了你自己的情绪，还多了 \"我不能代替 ta 决定\" 的恐惧。一个有用的问题是：\"如果 ta 知道我因为这件物品而每天压抑、空间被占、不敢开柜子，ta 会希望我继续留着吗？\" 大多数人在心里给出的答案是 \"不会\"。然后你才能开始做真正属于你的决定。如果家里有其他人也对这些物品有感情，先问一圈是否有人想要——但不要让 \"等大家决定\" 变成永远不动。设一个截止日期：到了那天，没有人来认领的物品，你有权处理。",
      mistakesTitle: "整理情感物品时最常见的错误",
      mistakes: [
        "把 sentimental items 放在 declutter 的第一项——决策最重的应该放在最后，先用更简单的物品练习决策肌肉",
      ...
      quickResetSteps: [
        ...
        "设 15 分钟计时器",
        "拿起每一件，先说出（或写下）你的感觉",
        "拿不准的拍照，封进 maybe box，30-90 天后再决定",
      ],
      faqTitle: "常见问题",
      faqs: [
