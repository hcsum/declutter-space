...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      description:
        "亡くなった大切な人の持ち物を整理することは、家事ではなく悲しみと向き合う作業（グリーフワーク）です。急がず進めるためのやさしいガイドとして、遺品や思い出の品を何から見ればいいか、何を残し、何を手放すか、罪悪感への向き合い方をまとめました。",
      eyebrow: "手放し方ガイド",
      heroTitle: "大切な人が亡くなった後の片付け方: やさしい遺品整理ガイド",
      heroSubtitle:
        "誰かが亡くなった後にその人の持ち物を整理するのは、家事ではなく悲しみと向き合う作業（グリーフワーク）です。相手を大切に思うために、すべてを残す必要はありません。ここでは、急がず進める方法と、残った物をどう扱うかを整理します。",
      introTitle: "全部残すことは、その人を残すことではない",
      introBody:
        "物を手放すことは、その人まで手放すことのように感じられるかもしれません。失礼ではないか、相手が傷つくのではないか、という不安も自然です。でも愛情や記憶は物の中ではなく、あなたの中にあります。家いっぱいに持ち物が残ると、引き出しを開けるたびに悲しみが揺り戻され、気持ちが前に進めなくなることもあります。意味のある少数を残し、残りを手放してよいのです。それは裏切りではなく、悲しみが前に進む形です。ここに締め切りも、正しい数もありません。",
      ...
      items: [
        ...
        },
        {
          ...
          body: "遺品を売ることはその人に値段をつけるように感じられ、寄付することはその人を軽く扱うように感じられるかもしれません。でもその罪悪感は悲しみの一部であって、間違ったことをしている証拠ではありません。",
      ...
      faqs: [
        ...
        ["持ち物を手放すことに強い罪悪感があります。普通ですか？", "とても普通です。その罪悪感は悲しみの一部であり、間違っているサインではありません。誰かの役に立つ形で遺品を寄付することは、その人の名における贈り物でもあり、やさしさを次へつなぐ方法でもあります。"],
