...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      principlesBody: "デス・クリーニングは不吉な締め切りではなく、ゆっくりで親切な整理の方法です。この2つの考え方が、その空気を保ってくれます。",
      ...
      principle2Body:
        "デス・クリーニングの静かな核心は会話です。家族に『これ、今ほしい？』と聞けるのは、答えの背景にある思い出も聞ける今だからです。誰も望まない物は、罪悪感なく手放せます。一方で、受け取る側だった人たちからは『親が全部ひそかに片付けてしまい、自分たちが思い出をたどる機会を奪われたように感じた』という声もあります。解決策は全部残すことではなく、話すことです。そして『あなたは私が残した物を持ち続ける義務はない』と、はっきり伝えることです。",
      faqTitle: "よくある質問",
      faqs: [
        ["Swedish death cleaning は高齢者だけのものですか？", "いいえ。Magnusson は50歳ごろから始めることを勧めていますが、この習慣はどの年齢にも合います。大切な物だけを残すほど、今の暮らしも軽くなります。デス・クリーニングは、長い目で見た片付けと考えると分かりやすいです。"],
        ["KonMari とはどう違いますか？", "KonMari は『ときめくか』を基準にし、短期間に強く進めることが多い方法です。デス・クリーニングはもっとゆっくりで、他者への配慮が軸です。『自分がいなくなったあと、これを残してもよいか』を問い、数か月から数年かけてカテゴリごとに進めます。"],
        ["圧倒されるときは、どこから始めればいいですか？", "いちばん感情の薄いカテゴリからです。ガレージ、重複品、ジャンク引き出しなど。簡単な勝ちが勢いを作り、そのあとで思い出の品に向き合いやすくなります。難しい物は判断ガイドも役立ちます。"],
        ["思い出の品はどうすればいいですか？", "最後に回し、よく代表する少数だけ残して、残りは写真にします。記憶は棚のスペースではなく、あなた自身や写真の中にも残ります。やさしく進める方法は、思い出の品の片付けガイドも参考になります。"],
        ["年老いた親にどうやって始めてもらえばいいですか？", "やさしく、そして一気にやろうとしないことです。多くの親は『自分が死んだあとで片付けてくれればいい』と構えたり、何かを手放す提案だけで不安定になったりします。強く押すと逆効果です。比較的うまくいきやすいのは、『自分が今ほしい物だけ譲ってもらう』『寄付の手配はこちらがやる』『人生全体の整理としてではなく、負担の少ない1カテゴリだけ一緒にやる』ことです。強制はできませんが、『はい』と言いやすくはできます。"],
      ],
      relatedTitle: "関連記事",
      relatedIntro: "デス・クリーニングでは、思い出の品、遺品、日常の判断がすべてつながります。次に読むならこちら:",
      relatedLinks: [
        ...
        { href: "/decluttering-before-a-move", label: "引っ越し前の片付けと持ち物の整理" },
        { href: "/decluttering-decision-guide", label: "判断に迷う物の判断ガイド" },
