...
function getCopy(locale: string): GuideCopy {
  ...
  if (locale === "ja") {
    return {
      ...
      heroSubtitle:
        "よいキッチンの片付けは、毎日の料理を面倒にするものではなく、むしろ楽にするものです。期限切れの食品、重複した道具、カウンターのあふれを減らして、下ごしらえ、片付け、食事の流れをスムーズに戻しましょう。",
      introTitle: "キッチンの散らかりは作業の流れの乱れとして表れやすい",
      introBody:
        "キッチンの散らかりはたいてい偶然ではありません。いつか使うかもしれないスパイス、重複した調理グッズ、自分で選んでいないマグ、ふたのない容器、容器のないふた、一時は便利だったけれど今は邪魔な家電。強いリセットは、料理する・洗う・しまうという本来の作業の流れを守るところから始まります。",
      stepsTitle: "キッチンを片付ける 7 つのステップ",
      steps: [
        ["1. 明らかに期限切れ・破損・使用不可の物を捨てる", "賞味期限切れの食品、風味の抜けたスパイス、傷んだ食材、壊れた保存容器、欠けた食器から始めます。キッチンには最初に減らせる、明らかに不要な物がたくさんあります。"],
        ["2. 食品庫・冷蔵庫・調味料ゾーンをリセットする", "似た物をまとめると、重複、期限が近い食品、勢いで買ったままの物がすぐ見えてきます。"],
        ["3. 重複した調理グッズとおまけの食器を減らす", "予備の計量カップ、スパチュラ、缶切り、ノベルティのマグ、使い捨てカトラリーは、価値以上に引き出しや戸棚を埋めがちです。"],
        ["4. 小型家電を正直に見直す", "炊飯器、ノンフライヤー、ミキサー、ジューサーは、定期的に使うことでスペースを正当化できる物です。そうでないなら収納コストの高い散らかりです。"],
        ["5. 散らかりやすい 2 か所を整える", "保存容器と調理器具は特に乱れやすい場所です。合わないふた、ゆがんだプラスチック、さびた鍋、洗いにくい道具は料理を面倒にします。"],
        ["6. カウンターは本当に毎日使う物のために空ける", "カウンターはあふれた物の置き場ではなく作業面です。毎日の料理や習慣を支える物だけを残しましょう。"],
        ["7. 料理の流れに合わせて戻す", "調理器具、スパイス、下ごしらえ道具、食器は、実際に使う位置の近くに置きます。動きに合ったキッチンほど維持しやすくなります。"],
      ],
      ...
      removeItems: [
        ...
        "重複した調理グッズやノベルティのマグ",
        "何か月も使っていない小型家電",
        "欠けた・ゆがんだ・さびた・使いにくい調理器具",
      ],
      emotionTitle: "よいキッチンは個性ではなく摩擦を減らす",
      emotionBody:
        "落ち着くキッチンは、必ずしもミニマルに見える必要はありません。必要なのは摩擦が少ないことです。カウンターが広く、引き出しがすっと閉まり、実際に使う食材が見えるだけで、料理はかなり消耗しにくくなります。勝ち筋は『少なく持つこと』そのものではなく、日常生活をよりスムーズに支えるキッチンに戻すことです。",
      mistakesTitle: "キッチンの片付けでよくある失敗",
      mistakes: [
        "戸棚や引き出しのあふれを直さず、カウンターだけ片付ける",
        "高かったという理由で、ほとんど使わない家電を残す",
        "期限切れ食品を捨てずに先に収納する",
        "キッチンを作業する部屋ではなく物置として扱う",
      ],
      keepTitle: "キッチンで手の届きやすい場所に置くべきもの",
      keepBody:
        "普段の 1 週間で実際に使う物を、必要な場所の近くに置きましょう。毎日使う食器は食洗機や水切りの近く、下ごしらえ道具は主な作業面の近く、よく使う油・スパイス・調理器具はコンロの近く。理想の流れではなく、現実の習慣に一等地を渡すのがコツです。",
      quickResetTitle: "15 分でキッチンを片付ける方法",
      quickResetSteps: [
        "期限切れ食品を捨て、カウンターの明らかなゴミを片付ける",
        "重複したマグ、調理器具、保存容器を一か所に集める",
        "冷蔵庫、食品庫の棚、カトラリー引き出しのどれか 1 つを終わらせる",
        "今週の料理を支える物だけを戻す",
      ],
      faqTitle: "キッチンの片付けのよくある質問",
      faqs: [
        ...
        ["小型家電はいくつまでカウンターに置いていい？", "しまうと実際の作業が遅くなるほど頻繁に使う物だけです。それ以外は戸棚のスペースを取る価値があるか、手放すかを決めましょう。"],
      ],
      toolTitle: "キッチンチェックリストから始める",
      toolDesc:
        "このインタラクティブなチェックリストは、専用のキッチンチェックリストページと同じライブデータを使っています。どちらのページからでも項目のチェック、追加、進捗の保存ができます。",
      toolPage: "キッチンチェックリストのページを開く",
