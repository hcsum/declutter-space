...
function getCopy(locale: string): GuideCopy {
  ...
  if (locale === "ja") {
    return {
      title: "キッチンの片付け方 | ステップで進めるキッチン整理ガイド | DeclutterYourHome",
      description:
        "賞味期限切れの食品、重複した道具、散らかったカウンター、使っていない小型家電を見直して、料理しやすいキッチンに整える方法を紹介します。",
      eyebrow: "キッチンガイド",
      heroTitle: "料理しにくくせずにキッチンを片付ける方法",
      heroSubtitle:
        "よいキッチンの declutter は、毎日の料理を面倒にするものではなく、むしろ楽にするものです。期限切れの食品、重複した道具、カウンターの overflow を減らして、下ごしらえ、片付け、食事の流れをスムーズに戻しましょう。",
      introTitle: "キッチンの clutter は workflow の乱れとして表れやすい",
      introBody:
        "キッチンの clutter はたいてい偶然ではありません。いつか使うかもしれないスパイス、重複した gadget、自分で選んでいないマグ、ふたのない容器、容器のないふた、一時は便利だったけれど今は邪魔な家電。強いリセットは、料理する・洗う・しまうという本来の workflow を守るところから始まります。",
      stepsTitle: "キッチンを片付ける 7 つのステップ",
      steps: [
        ["1. 明らかに期限切れ・破損・使用不可の物を捨てる", "賞味期限切れの食品、風味の抜けたスパイス、傷んだ食材、壊れた保存容器、欠けた食器から始めます。キッチンには最初に減らせる obvious no がたくさんあります。"],
        ["2. pantry・冷蔵庫・調味料ゾーンをリセットする", "似た物をまとめると、重複、期限が近い食品、勢いで買ったままの物がすぐ見えてきます。"],
        ["3. 重複した gadget と freebie tableware を減らす", "予備の計量カップ、スパチュラ、缶切り、ノベルティのマグ、使い捨てカトラリーは、価値以上に引き出しや戸棚を埋めがちです。"],
        ["4. 小型家電を正直に見直す", "炊飯器、air fryer、blender、juicer は、定期的に使うことでスペースを正当化できる物です。そうでないなら収納コストの高い clutter です。"],
        ["5. chaos magnet になりやすい 2 か所を整える", "保存容器と cookware は特に乱れやすい場所です。合わないふた、ゆがんだプラスチック、さびた鍋、洗いにくい道具は料理を面倒にします。"],
        ["6. カウンターは本当の daily essentials のために空ける", "カウンターは overflow storage ではなく作業面です。毎日の料理や routine を支える物だけを残しましょう。"],
        ["7. cooking workflow に合わせて戻す", "調理器具、スパイス、下ごしらえ道具、食器は、実際に使う位置の近くに置きます。動きに合ったキッチンほど維持しやすくなります。"],
      ],
      removeTitle: "キッチンで最初に減らしたいもの",
      removeItems: [
        "期限切れ、またはもう食べない食品",
        "風味が抜けたスパイスや調味料",
        "そろっていない保存容器とふた",
        "重複した gadget やノベルティのマグ",
        "何か月も使っていない小型家電",
        "欠けた・ゆがんだ・さびた・使いにくい cookware",
      ],
      emotionTitle: "よいキッチンは personality ではなく摩擦を減らす",
      emotionBody:
        "落ち着くキッチンは、必ずしもミニマルに見える必要はありません。必要なのは friction が少ないことです。カウンターが広く、引き出しがすっと閉まり、実際に使う食材が見えるだけで、料理はかなり消耗しにくくなります。勝ち筋は『少なく持つこと』そのものではなく、日常生活をよりスムーズに支えるキッチンに戻すことです。",
      mistakesTitle: "キッチンの片付けでよくある失敗",
      mistakes: [
        "戸棚や引き出しの overflow を直さず、カウンターだけ片付ける",
        "高かったという理由で、ほとんど使わない家電を残す",
        "期限切れ食品を捨てずに先に収納する",
        "キッチンを作業する部屋ではなく storage として扱う",
      ],
      keepTitle: "キッチンで手の届きやすい場所に置くべきもの",
      keepBody:
        "普段の 1 週間で実際に使う物を、必要な場所の近くに置きましょう。毎日使う食器は食洗機や水切りの近く、下ごしらえ道具は主な作業面の近く、よく使う油・スパイス・調理器具はコンロの近く。理想の routine ではなく、現実の習慣に一等地を渡すのがコツです。",
      quickResetTitle: "15 分でキッチンを片付ける方法",
      quickResetSteps: [
        "期限切れ食品を捨て、カウンターの明らかなゴミを片付ける",
        "重複したマグ、調理器具、保存容器を一か所に集める",
        "冷蔵庫、pantry の棚、カトラリー引き出しのどれか 1 つを終わらせる",
        "今週の料理を支える物だけを戻す",
      ],
      faqTitle: "キッチンの片付け FAQ",
      faqs: [
        ["キッチンはどれくらいの頻度で片付けるべき？", "毎週の軽いリセットと、数か月ごとの少し深い見直しのほうが、大掃除を待つより維持しやすいです。"],
        ["散らかったキッチンはどこから始めるのが早い？", "期限切れ食品、重複した保存容器、混んだカウンターからです。この 3 か所が一番早く見た目を変えます。"],
        ["小型家電はいくつまでカウンターに置いていい？", "しまうと実際の routine が遅くなるほど頻繁に使う物だけです。それ以外は戸棚のスペースを取る価値があるか、手放すかを決めましょう。"],
      ],
      toolTitle: "Kitchen Checklist から始める",
      toolDesc:
        "このインタラクティブなチェックリストは、専用の Kitchen Checklist ページと同じライブデータを使っています。どちらのページからでも項目のチェック、追加、進捗の保存ができます。",
      toolPage: "Kitchen Checklist ページを開く",
      blockersTitle: "キッチンの散らかりの奥にある感情的なつまずき",
      blockersBody:
        "キッチンは機能的な部屋に見えても、感情の残りはしっかりあります。もらい物の鍋への罪悪感、いつか使うかもしれないと残したスパイス、料理ブームの時期に買った用途が一つだけの家電、過去の関係から残ったキッチン用品。必要だから残っているのではなく、決めること自体が決断疲れだから残っているのです。まずその感情を言語化し、それから『使うか、手放すか』を当ててください。過去 12 か月で出番がなかった物は、次の 12 か月でも出番がない可能性が高いです。",
      relatedTitle: "関連ガイド",
