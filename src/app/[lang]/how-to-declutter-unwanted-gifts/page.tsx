    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          action: "おもちゃには one-in-one-out を使い、1つ入ったら1つ寄付しましょう。あわせて、よく贈ってくれる人には事前に『体験型ギフトや消耗品がうれしい』と伝えると入口から減らせます。",
        },
        {
      ...
      faqs: [
        ...
        ["そもそも、いらないギフトをもらわないようにするには？", "よく贈ってくれる人に、前もって具体的に伝えましょう。一緒の食事、体験、消耗品、wishlist など、自分が本当にうれしいものを知らせるのがいちばんです。家に入ってから悩むより、入口で整える方がずっと楽です。"],
      ],
      relatedTitle: "関連ガイド",
