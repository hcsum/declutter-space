...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      title: "いらないギフトを罪悪感なく手放す方法 | DeclutterYourHome",
      description:
        "使わないプレゼントを持ち続けることは感謝ではなく、罪悪感の保管です。よくある8つのギフト悩み別に、返す・譲る・寄付する・売る・写真に残す方法と、不要なギフトを増やさないコツをまとめました。",
      eyebrow: "手放し方ガイド",
      heroTitle: "いらないギフトを罪悪感なく手放す方法",
      heroSubtitle:
        "使わないギフトを持ち続けても、贈ってくれた人を大切にしている証明にはなりません。ただ罪悪感を保管しているだけです。このガイドでは、不要なプレゼントをどう手放すか、ケース別に具体的に紹介します。",
      introTitle: "本当の散らかりは、物より罪悪感",
      introBody:
        "ギフトの役目は、渡された瞬間にすでに終わっています。相手は気持ちを示し、あなたは受け取った。その事実はもう消えません。そのあと食器棚や引き出しに眠る物は、気持ちを深めるのではなく、善意を『ずっと保管しなければならない義務』に変えてしまいます。物を受け取ることと、その義務まで引き受けることは別です。スペースを取っているのはギフトそのものより、『手放したらひどい人だろうか』という考えのほうです。",
      itemsTitle: "よくある8つのギフト罪悪感と、実際の対処法",
      items: [
        {
          title: "1. 一度も使っていないギフト",
          body: "1年以上引き出しや棚の奥にあり、タグがついたままかもしれません。『お金をかけてもらったから』という理由で残していることが多いですが、持ち続けてもそのお金は戻らず、物も役立ちません。今の仕事は、いつか来ない『そのうち』を待ちながら場所を取ることだけです。",
          guilt: "せっかくお金を使って買ってくれた。",
          action: "寄付するか、必要な人に譲りましょう。実際に使ってくれる人の手に渡るほうが、ほこりをかぶるよりギフトを生かせます。お金はもう使われています。持ち続けても回収にはなりません。",
        },
        {
          title: "2. 母親やパートナーなど、近しい人からのギフト",
          body: "いちばん難しいのは、物ではなく『相手を傷つけるのでは』という不安があるからです。でも関係性は物に保存されていません。着ないマフラーが残り続けることで、母親やパートナーとの絆が成立しているわけではありません。",
          guilt: "相手が悲しむかもしれない。",
          action: "『これを今の自分がもう一度買うか』で判断してください。買うなら残す、買わないなら静かに手放す。報告義務はありません。本当にあなたを大切に思う人は、あなたに軽やかに暮らしてほしいのであって、自分の買った物の保管庫になってほしいわけではありません。",
        },
        {
          title: "3. 重複している、サイズが違う、好みに合わないギフト",
          body: "相手は思いやって選んでくれたかもしれません。でも思いやりと、『一生持つ義務』は別です。重複したキッチン用品、サイズの合わない服、好みではないインテリア。気持ちはもう受け取っています。",
          guilt: "せっかく選んでくれたのに。",
          action: "レシートがあれば返品、譲れるなら譲る、難しければ寄付で大丈夫です。受け取ったのは気持ちであって、物は次に進んで構いません。",
        },
        {
          title: "4. 手作りや、特別な意味のあるギフト",
          body: "手作りの物や特別な意味を持つ贈り物は、手放すと相手の努力まで否定するように感じやすいです。でも記憶は物ではなく自分の中にあり、見た目は写真でも残せます。",
          guilt: "手間をかけて作ってくれた。",
          action: "写真を撮り、残すなら代表的な1点までにしましょう。思い出は写真とストーリーに残ります。棚の占有面積ではありません。詳しくは『思い出の品の整理方法』も参考になります。",
        },
        {
          title: "5. 代々受け継いだ『ギフト』や形見",
          body: "祖母の食器や親族の家具のように、重みと一緒に手渡される物には『ちゃんと守ってね』という無言の圧がついてきます。でもあなたは家族の博物館ではありません。",
          guilt: "何代も受け継がれてきた物だから。",
          action: "本当に好きで、使うか飾る物だけを残しましょう。由来は文章や写真で記録し、残りは手放してかまいません。物を全部持つより、ストーリーを残す方が継承として強いです。",
        },
        {
          title: "6. もうやめた趣味のためにもらったギフト",
          body: "画材一式、楽器、スポーツ用品など、『これから本気でやる』時期にもらった物です。今それらが思い出させるのは、楽しかった期待より『続かなかった』という罪悪感かもしれません。",
          guilt: "いつかまた始めるかもしれない。",
          action: "安価で、必要になればまた買うか借りるのが簡単なら手放しましょう。本当に再開するときに、あらためて用意すれば十分です。『いつか』のために何年も収納スペースを払い続ける必要はありません。",
        },
        {
          title: "7. 子どもへのギフトが多すぎる",
          body: "祖父母や親戚からおもちゃが次々届き、子どもが遊ぶスピードより早く増えていくケースです。1つずつは小さく見えても、合計すると部屋全体を埋めます。",
          guilt: "いつも送ってくれるから、断りづらい。",
          action: "おもちゃには『1つ増えたら1つ手放す』ルールを使い、1つ入ったら1つ寄付しましょう。あわせて、よく贈ってくれる人には事前に『体験型ギフトや消耗品がうれしい』と伝えると入口から減らせます。",
        },
        {
          title: "8. 結婚祝いやイベントギフトの残り",
          body: "引き出物、食器セット、装飾品など、節目にひもづいた物は手放しにくくなります。でも大切な日や関係性そのものは、使っていないグレービーボートに保存されているわけではありません。",
          guilt: "でも結婚祝いでもらった物だから。",
          action: "実際に使っている物だけ残し、あとは手放しましょう。1つ食器を減らしても、結婚生活の価値は何も減りません。",
        },
      ],
      principlesTitle: "罪悪感をほどく2つの考え方",
      principlesBody: "ギフトを手放せない理由は、動作ではなく感情です。次の2つは、その結び目をゆるめるための考え方です。",
      principle1Heading: "ギフトの役目は、渡された瞬間に完了している",
      principle1Body:
        "ギフトは『あなたを大切に思っている』という行為であり、手渡された時点で届いています。その後に物をどう扱うかは、時間をさかのぼって相手の気持ちを取り消すものではありません。寄付しても、過去の気持ちを拒絶したことにはなりません。気持ちはすでに届き、物は自由です。",
      principle2Heading: "30日以内の手放しウィンドウ",
      principle2Body:
        "いらないギフトを無期限に置かないでください。30日ほどの期限を決めて、使う・返品する・譲る・寄付する・売るのどれかを選びます。長く置くほど『大事な物』に見えますが、それは意味ではなく惰性です。",
      faqTitle: "よくある質問",
      faqs: [
        ["ギフトを処分するのは失礼で、感謝がないことになりませんか？", "なりません。感謝しているのは『あなたのことを思ってくれた行為』に対してであり、物を一生保管する契約ではありません。礼儀は受け取った時点で果たされています。その後どう扱うかはあなたが決めてよいことです。"],
        ["相手に場所を聞かれたり、家に来て見つからなかったら？", "多くの人は自分が何を贈ったか細かく覚えていませんし、在庫確認もしません。もし聞かれたら、『もっと使ってくれる人に渡したよ』くらいの穏やかな正直さで十分です。特に近しい相手なら、飾れる物を1つだけ残し、残りを手放す方法でも大丈夫です。"],
        ["亡くなった人からのギフトはどうすればいいですか？", "悲しみは義務ではありません。思い出す証明のために、すべての物を持つ必要はありません。代表的な数点だけ残し、残りは写真にして手放して大丈夫です。記憶が薄れるわけではありません。やさしい進め方は『思い出の品の整理方法』を参考にしてください。"],
        ["そもそも、いらないギフトをもらわないようにするには？", "よく贈ってくれる人に、前もって具体的に伝えましょう。一緒の食事、体験、消耗品、ほしい物リストなど、自分が本当にうれしいものを知らせるのがいちばんです。家に入ってから悩むより、入口で整える方がずっと楽です。"],
      ],
      relatedTitle: "関連ガイド",
      relatedIntro: "ギフトの罪悪感は、思い出の品や買い物習慣ともつながっています。次はこちら。",
      relatedLinks: [
        { href: "/how-to-declutter-sentimental-items", label: "思い出の品を罪悪感なく整理する方法" },
        { href: "/decluttering-after-a-death", label: "死別後の片付けガイド" },
        { href: "/things-to-stop-buying", label: "買うのをやめたい物10選" },
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          guilt: "这东西在家里传了好几代了。",
          action: "留下你真心喜欢、会用或会摆出来的；把它的故事记下来或拍下来；其余的可以放手。记录下故事，比堆着一柜子你从不看的物件，更能传承。",
        },
        {
        ...
        },
        {
          ...
          guilt: "外婆一直在寄，我不好意思。",
          action: "对玩具用 \"一进一出\"：进一件，旧的捐一件。并提前告诉常送礼的人，你们更希望收到体验（一起出去玩）或消耗品。",
        },
        {
      ...
      faqs: [
        ...
        ["怎么从源头减少收到不想要的礼物？", "提前、明确地告诉常送礼的人你更希望收到什么：一起吃顿饭、一次体验、消耗品，或者干脆给一个心愿单。在物品进家之前就处理，比进来之后再纠结轻松得多。延伸阅读 \"该停止买的东西\"。"],
      ],
      relatedTitle: "相关阅读",
