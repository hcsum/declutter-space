...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      description:
        "ADHDの脳に合わせた掃除・片付けチェックリスト。部屋別の小さな作業、先送りボックス / 保留ボックス、5分・15分・30分の時間区切り、決断疲れと感覚過負荷への対策をまとめました。",
      eyebrow: "ADHD Guide",
      heroTitle: "ADHD向け掃除・片付けチェックリスト",
      heroSubtitle:
        "ADHDの人にとって家事が難しい理由は、体力不足ではなく実行機能の弱りや決断疲れにあります。このチェックリストは各部屋を小さな作業に分解し、先送りボックスや時間区切りなど ADHD 向けの方法と組み合わせることで、「どこから始めればいいか分からない」を「1つずつ終わらせられる」に変えます。",
      introTitle: "ADHDの脳だと掃除で止まりやすい理由",
      introBody:
        "ADHDの人が散らかった部屋の前で止まりやすいのは、単にやる気の問題ではありません。決断疲れで判断のたびにエネルギーが削られ、時間感覚のずれで「あとでやる」が延び続け、感覚過負荷で視覚的な散らかり自体が逃げたくなる刺激になります。必要なのは『もっと頑張ること』ではなく、タスクの構造を変えることです。大きな作業を考えなくて済む小さな作業に分け、意志力の代わりにタイマーを使い、判断の代わりに入れ物を使います。",
      ...
      whyHardItems: [
        ...
        ["決断疲れ", "物1つごとに『残す？ 捨てる？』と判断していると、すぐにエネルギー切れになります。最初の10個は決められても、30個目では雑な判断になりがちです。"],
      ...
      checklistIntro:
        "以下は ADHD 向けの掃除チェックリストです。すべて5分以内で終えやすい小さな作業として設計してあります。各部屋で1〜3個できれば成功で、全部やる必要はありません。",
      rooms: [
        {
          heading: "キッチン（5つの小さな作業）",
        ...
        {
          heading: "ホームオフィス（5つの小さな作業）",
          intro: "散らかった作業机は『これを片付けるまで仕事を始められない』という停止パターンを起こしやすくします。小さな作業を1つやって、その流れを切りましょう。",
          microTasks: [
            "机の上のカップ、包装、ゴミを全部どける",
            "書けなくなったペンを全部捨てる",
      ...
      methodsTitle: "ADHD向けの2つの方法: 先送りボックスと保留ボックス",
      methodsIntro:
        "この2つは r/declutteringadhd や r/adhdwomen で繰り返し出てくる方法です。掃除そのものを解決するというより、ADHDの脳が『今は決められない』場面で止まるのを防ぎます。",
      doomBoxHeading: "先送りボックスの方法",
      doomBoxBody:
        "先送りボックスは、今その場で判断する余力がない物を入れるための容器です。見覚えのない充電器、開けていない郵便物、置き場所が決められない細かい物はそこへ入れます。目的はそれらを永久保存することではなく、『決めること』が『前に進むこと』の邪魔をしないようにすることです。週1回15分など、先送りボックスだけを処理する時間を予定に入れてください。その時間だけ判断に集中したほうが、家中を回りながら1つずつ決めるよりずっと楽です。",
      maybeBoxHeading: "保留ボックスの方法",
      maybeBoxBody:
        "保留ボックスは先送りボックスに近いですが、用途が少し違います。『手放したほうがいい気はするけれど、今は捨て切れない』物を入れる箱です。封をして日付を書き、見えない場所に置きます。30〜90日後、その箱を開けて何か取り出したことがなければ、箱ごと手放せます。もう一度判断しなくてよいので、ADHDの脳には今すぐ白黒つけるよりずっとやさしい方法です。",
      timeBoxTitle: "時間を区切る方法: 意志力ではなくタイマーを使う",
      timeBoxIntro:
        "ADHD の脳は『タスクを完了する』より『X分だけやる』のほうが扱いやすい傾向があります。『リビング全部を片付ける』より『15分だけ掃除する』のほうが、はるかに現実的です。",
      timeBoxBlocks: [
        {
          heading: "5分スタート",
          body: "できるだけ小さい作業を1つ選び、5分タイマーをセットして、鳴ったら止めます。いわゆる5分ルールです。5分なら大きな約束に感じにくいので、始めるハードルを下げられます。多くの場合は5分を超えて続けられますが、『5分で止めていい』こと自体がスタートの鍵になります。",
        },
        {
        ...
        {
          heading: "25/5 ポモドーロ",
          body: "過集中に入りやすい人は、25分作業して5分休むリズムを使います。休憩ではその部屋を離れ、水を飲むかストレッチしてください。スマホを見始めると別の過集中に吸われて、掃除セッションが終わりやすくなります。",
        },
      ],
      ...
      declutterComboTitle: "掃除しながら片付ける: ADHD向けの組み合わせ方",
      declutterComboBody:
        "神経定型の人には『先に掃除、あとで片付け』が機能しても、ADHDの脳ではどちらも終わらないことがよくあります。現実的なのは一緒にやることです。コンロを拭くついでに期限切れのスパイスを捨てる。ベッドを整えるついでに着ていないシャツを寄付袋へ入れる。ゴミを出すついでに机の書けないペンも持っていく。片付けを別プロジェクトにせず、掃除動作の中へ埋め込むことが、ADHDでも実行しやすい形です。",
      mistakesTitle: "ADHDの片付けで踏みがちな4つの落とし穴",
      mistakes: [
        "完璧主義の罠: 部屋全体を完璧に終えられないなら始めない。結果: 永遠に始まらない。",
        "全部かゼロか思考: 今日全部終わらなかったから、今日は無意味だった。結果: その週ごと放棄する。",
        "記憶をシステム代わりにする: 何をやるべきかを脳だけで覚えておこうとするのは ADHD 最大の罠です。チェックリスト、タイマー、容器、アラームで全部外部化します。",
        "片付け前に収納用品を買う: 先に片付けていない段階で収納ボックスを増やすと、あとで管理する物が増えるだけです。",
      ],
      quickWinsTitle: "30秒 / 5分 / 15分ですぐできること",
      quickWins: [
        {
          heading: "30秒でできること",
        ...
        {
          heading: "15分でできること",
          body: "1部屋分の小さな作業を一通りやる。先送りボックスを1回処理する。小さな棚を1つ整える。食器を洗ってコンロを拭く。浴室のクイックリセットをする。",
        },
      ],
      faqTitle: "よくある質問",
      faqs: [
  ...
  if (locale === "zh") {
    return {
      ...
      eyebrow: "ADHD Guide",
      heroTitle: "ADHD 友好的家务清洁与整理清单",
      heroSubtitle:
        "ADHD 大脑做家务最难的不是体力，而是执行功能和决策疲劳。这份清单把每个房间拆成微任务，配合暂存盒、时间分段等 ADHD 友好的方法，让 \"不知道从哪开始\" 变成 \"做完一项算一项\"。",
      introTitle: "为什么 ADHD 大脑做家务会卡住",
      introBody:
        "和神经典型大脑不一样，ADHD 用户面对乱屋子时常常同时遇到 3 件事：决策疲劳让每个选择都消耗能量、时间盲让 \"我等会再做\" 一直延后、感官过载让杂乱的视觉本身就让人想逃跑。所以解决方法不是 \"再努力一点\"，而是改变任务的结构——把大任务拆成不需要思考的微任务，用计时器替代意志力，用容器替代决定。",
      whyHardTitle: "ADHD 让家务难做的 3 个核心原因",
      whyHardItems: [
        ["Executive dysfunction（执行功能障碍）", "知道该做什么 ≠ 能开始做。从沙发起身到拿起抹布之间的那一步，对 ADHD 大脑来说常常是最难的一步。"],
        ["决策疲劳", "每件杂物都问一次 \"留还是扔\"，能量很快用完。前 10 件能决定，第 30 件已经在乱选。"],
        ["感官过载", "视觉混乱本身就是触发器。看到乱的房间，大脑反应不是 \"我来收拾\"，而是 \"我要离开这里\"。"],
      ],
      checklistTitle: "按房间分类的 ADHD 家务清单",
      checklistIntro:
        "这是一份 ADHD 家务清洁清单——每一项都设计成 5 分钟以内可以完成的微任务，每个房间挑 1-3 项就算成功，不需要做完所有。",
      rooms: [
        {
          heading: "厨房（5 个微任务）",
      ...
      methodsTitle: "两个 ADHD 专属方法：暂存盒和待定盒",
      methodsIntro:
        "这两个方法是 r/declutteringadhd 和 r/adhdwomen 反复提到的——它们不解决整理本身，但解决 ADHD 大脑无法做决定时的卡顿。",
      doomBoxHeading: "暂存盒方法",
      doomBoxBody:
        "暂存盒是 ADHD 社区里很常见的概念：一个专门装 \"我现在没有精力决定\" 的物品的容器。看到一件不知道放哪、不知道是否要扔的东西，先丢进暂存盒，关上盖子，继续做眼前的事。暂存盒的目标不是永远装着东西，而是不让 \"决定\" 阻塞 \"前进\"。设一个固定时间——比如每周日 15 分钟——专门处理暂存盒，那时大脑只专注于决策这一件事。",
      maybeBoxHeading: "待定盒方法",
      maybeBoxBody:
        "待定盒和暂存盒很像，但用法不同。待定盒装的是你 \"觉得可能要扔但又不敢扔\" 的东西。封箱、写日期、收到看不见的地方。30-90 天后，如果你没有打开找过任何东西，整箱可以处理掉——不用再做一次决定。待定盒让决策变成 \"等待\"，对 ADHD 大脑友好得多。",
      timeBoxTitle: "时间分段：用计时器替代意志力",
      timeBoxIntro:
        "ADHD 大脑对 \"完成一整件事\" 没有概念，但对 \"做 X 分钟\" 有。用计时器把任务切成段，比 \"今天要收拾完整个客厅\" 现实得多。",
      timeBoxBlocks: [
        {
          heading: "5 分钟启动",
          body: "选一个最小的微任务，设 5 分钟计时器，时间到就停。这个方法叫 5 分钟规则。它绕过 ADHD 大脑的启动障碍——因为 5 分钟感觉不像承诺。多数情况下你会做超过 5 分钟，但 \"被允许 5 分钟就停\" 是动起来的关键。",
        },
        {
        ...
        {
          heading: "25/5 番茄钟",
          body: "如果你能进入过度专注状态（ADHD 的双刃剑），用 25 分钟工作 + 5 分钟休息的节奏。休息时强制离开当前房间，喝水或拉伸——不要看手机，否则容易卡进另一轮过度专注。",
        },
      ],
      ...
      steps: [
        ...
        ["4. 拿一个容器，不要一边整理一边决定", "就算没人陪着做也行：用篮子或暂存盒替代决策。所有不知道怎么办的东西先丢进去，统一时间处理。"],
        ["5. 做完后给自己一个明确的奖励", "ADHD 大脑对延迟奖励反应弱。做完一段就立刻奖励——一杯咖啡、5 分钟手机、一集喜剧。把奖励和动作绑定，下次启动更容易。"],
        ["6. 视觉化进度", "用计时器、清单、贴纸都可以——把无形的 \"我做了一些\" 变成有形的 \"我完成了 3/5 项\"。ADHD 大脑需要看到进度。"],
        ["7. 不追求完美的一次，追求重复的多次", "比起一次完美的大扫除，每天 10 分钟的小整理对 ADHD 屋更有效。频率比强度更重要。"],
      ],
      declutterComboTitle: "边打扫边整理：ADHD 友好的合并法",
      declutterComboBody:
        "对 ADHD 大脑，分开做 \"先打扫再整理\" 通常等于两次都不做完。更现实的做法是合并：擦灶台时顺手把过期香料扔了，整理床时顺手把不会再穿的衣服丢进捐赠袋，倒垃圾时顺手把抽屉里的过期票根带出去。把整理嵌入清洁动作里，而不是当作独立任务——这才是 ADHD 真正做得完的版本。",
      mistakesTitle: "ADHD 整理最容易踩的 4 个坑",
      mistakes: [
        "完美主义陷阱：要么完美做完整个房间，要么不开始。结果：永远不开始。",
        "全有或全无思维：今天没做完所有，等于今天没做。结果：放弃整个一周。",
        "没系统就想靠记忆：依靠记忆是 ADHD 大脑最大的陷阱。永远要用 checklist、计时器、容器外化决策。",
        "买更多收纳：在没有先整理之前买收纳箱，等于又增加了需要整理的东西。",
      ],
      quickWinsTitle: "30 秒 / 5 分钟 / 15 分钟分级快速动作",
      quickWins: [
        {
          heading: "30 秒能做的事",
        ...
        {
          heading: "15 分钟能做的事",
          body: "做完一个房间的所有微任务；处理一次暂存盒；整理一个小柜子；洗碗 + 擦灶台；做一次浴室快速重置。",
        },
      ],
      faqTitle: "常见问题",
      faqs: [
