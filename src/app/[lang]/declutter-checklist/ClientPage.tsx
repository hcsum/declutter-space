...
export default function ClientPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f9faf2] pt-16 text-[#1a1c18] md:block">
      <aside className="print-hidden hidden h-[calc(100vh-4rem)] w-64 flex-col bg-[#f3f4ec] p-6 shadow-xl shadow-[#1a1c18]/5 md:fixed md:bottom-0 md:left-0 md:top-16 md:flex">
      ...
      <div className="flex min-w-0 flex-1 flex-col md:ml-64 print:ml-0">
        ...
        <section className="flex-1 space-y-8 px-5 pb-10 pt-4 md:px-8">
          ...
          <section className="print-hidden rounded-[2rem] bg-white p-6 shadow-sm md:p-8">
          ...
          {selectedHistoryDate && (
            <section className="print-hidden rounded-[2rem] bg-[#edefe7] p-6 md:p-8">
          ...
          <section className="print-hidden rounded-[2rem] bg-[#002d1c] p-8 text-white">
      ...
      <button
        ...
        className="print-hidden fixed bottom-5 left-5 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-[#002d1c] text-white shadow-lg shadow-[#1a1c18]/20 md:hidden"
      >
