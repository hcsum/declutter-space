  ...
  if (locale === "ja") {
    return {
      ...
      faqs: [
        ...
        ["迷う物はどうすればいいですか？", "無理に決めないでください。『maybe box』を1つ用意し、日付を書いて封をして見えない場所に置きます。60〜90日たっても一度も開けなかったなら、中身を見直さず箱ごと手放して大丈夫です。"],
        ["寄付やリサイクルはどこに持っていけばいいですか？", "期限切れの化粧品や薬は、一般ごみではなく薬局の回収や自治体の有害ごみルートを使ってください。状態のよい衣類、キッチン用品、おもちゃはリサイクルショップや地域の寄付先へ。電子機器のケーブルや電池は家電回収・e-waste 回収へ持ち込み、通常の資源ごみに混ぜないようにしましょう。"],
      ],
      relatedTitle: "関連ガイド",
