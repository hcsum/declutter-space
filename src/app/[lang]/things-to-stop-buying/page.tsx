...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      title: "物が増える前にやめたい買い物10選 | DeclutterYourHome",
      description:
        "片付けても家がすぐ散らかる原因になりやすい買い物習慣を10種類紹介。買わないほうが捨て続けるより持続しやすい理由、代わりに取る行動、判断ルールをまとめました。",
      eyebrow: "散らからない家",
      heroTitle: "散らからない家のために、もう買うのをやめたい物10選",
      heroSubtitle:
        "片付けを続けても、買い続けていれば家はまた埋まります。このリストでは、家を静かに物で満たしてしまう10のカテゴリーと、買うのをやめる物、代わりにする行動をまとめています。",
      introTitle: "「もっと捨てる」より「買う量を減らす」ほうが続く理由",
      introBody:
        "週末に頑張って片付けても、数か月後には元に戻ることがよくあります。努力が足りないのではなく、買い続ける流れが止まっていないだけです。毎週新しい物が入ってきて、出ていく速度が追いつきません。散らからない家は、片付けの日につくられるのではなく、「カートに追加」を押す直前の判断で守られます。定期的に増えやすい10種類の買い物を止める方が、四半期ごとに大がかりな断捨離をするよりずっと楽です。",
      itemsTitle: "家をまた物で埋める10の買い物カテゴリー",
      items: [
        {
          title: "1. 安い収納ボックス",
          body: "収納用品を買うと、片付けが進んだように感じがちです。けれど安価なプラスチックケースは、実際には中身の判断を先送りしやすくします。ボックスは『使っている物の定位置』ではなく、『あとで考える物の保留箱』になりやすいからです。セールで勢いで買った収納ケースの多くは、結局そのままの保留の山を押し込んで終わります。",
          stop: "セール中の『あとで使うかも』な収納ボックス。",
          instead: "先に今ある収納を空にしてください。実際に収納が必要な量は、店頭で見えるボックスの数より30〜50%少ないことがよくあります。先に断捨離し、残った物に合わせて必要な収納だけを買いましょう。",
        },
        {
          title: "2. 無料サンプルやおまけ",
          body: "試供品、ノベルティバッグ、企業ロゴ入りメモ帳のような無料品は、お金を払っていないぶん吟味されずに家へ入りがちです。でも1つ1つがスペースを取り、あとで処分判断を要求し、多くは開けない引き出しに溜まっていきます。",
          stop: "使わない香水サンプル、不要なトートバッグ、イベントでもらうメモ帳。",
          instead: "入口で断る練習をしましょう。『大丈夫です、ありがとうございます』は、3か月後に捨てるよりずっと早いです。家が片付くのは、収納が上手だからではなく、入ってくる物が少ないからです。",
        },
        {
          title: "3. 単機能のキッチングッズ",
          body: "アボカドスライサー、バナナカッター、にんにくピーラー、いちごのヘタ取り、タコホルダー。どれも普通の包丁で代用できる作業ばかりです。安くて賢そうに見えるので増えやすい一方、引き出しの場所はずっと取り続けます。",
          stop: "めったにしない作業を1つだけ解決する道具。",
          instead: "包丁、まな板、フライパンで大半の調理は足ります。その道具を何か月も繰り返し欲しいと思ったときだけ買いましょう。レジ横で見かけた勢いでは買わないことです。",
        },
        {
          title: "4. 流行ベースで買う服",
          body: "マイクロトレンドは大量の購買を生みますが、着る期間はどんどん短くなっています。流行服はクローゼットが吸収できるより速く増え、ほとんどが1年以内に寄付袋へ入ります。",
          stop: "『今どこでも見かけるから』という理由で欲しくなる服。",
          instead: "30日待ってから買いましょう。その間に熱が冷めるなら流行に引っ張られていただけです。30日後も欲しいなら、自分の着方に合う可能性が高いです。",
        },
        {
          title: "5. 衝動的なネット通販（Amazon、Temu、Shein、TikTok Shop など）",
          body: "オンラインショッピングは摩擦がほぼゼロです。ワンクリック決済では、判断が数秒で終わりがちで、特に夜にスマホを見ているときほど買い物の精度は落ちます。2日後に届いた物が、部屋の中で急に浮いて見えることも少なくありません。",
          stop: "アプリを開く前から買う予定ではなかった『おすすめ』欄の商品。",
          instead: "カートではなくほしい物リストを使ってください。いったん追加して7日待ち、そのあとで見直します。火曜の夜に急いで見えた物は、月曜の朝には不要に見えることがよくあります。",
        },
        {
          title: "6. 旅行みやげのマグカップ、マグネット、小物",
          body: "人は思い出に形を与えたくておみやげを買います。でも旅の記憶を呼び戻す力は、ナイアガラのマグカップや州ごとのマグネットより、写真や文章のほうがずっと強いです。残るのは、ほこりを払う必要のある物だけになりがちです。",
          stop: "マグカップ、マグネット、ミニチュアの観光名所など『行った証明』系の物。",
          instead: "写真を多めに撮り、スマホのメモに旅のことを1段落だけ書いておきましょう。50枚の写真と短い記録の方が、1週間で見なくなる小物40個より記憶が残ります。",
        },
        {
          title: "7. 使い切れない大容量の日用品",
          body: "大容量シャンプー、ジャンボサイズの歯みがき粉、巨大ボトルの保湿剤。単価は安く見えますが、置き場所、期限切れのリスク、途中で好みが変わる可能性まで含めると、節約分が消えることも多いです。",
          stop: "使用期限が2年未満の商品の大容量買い。",
          instead: "今使っている商品の通常サイズを買い、なくなったら補充しましょう。単価は判断材料の1つにすぎません。収納スペースと使い切れる速度のほうが大事です。",
        },
        {
          title: "8. デコレーション用キャンドルと季節飾り",
          body: "キャンドルは使われないまま増え、季節飾りは数回出したら次の流行に置き換わります。どちらも1回の購入額が小さく、『季節ものだから』という言い訳がつくため、静かに蓄積します。",
          stop: "季節やイベントごとに新しい飾りを買うこと。",
          instead: "季節飾りはカテゴリーごとに収納ボックス1箱までに制限しましょう。箱がいっぱいなら、新しい物を1つ入れる前に古い物を1つ出します。キャンドルは、今あるものを使い切ってから次を買ってください。",
        },
        {
          title: "9. ラッピング用品とパーティーグッズ",
          body: "包装紙のロールは静かに増殖します。リボン、ギフトバッグ、薄紙、前回のパーティーで余った使い捨て皿が、『次に使うかも』で棚を埋めていきます。使用頻度の低い物で収納がふさがりやすいカテゴリーです。",
          stop: "『来年使えるかも』で買うセール品のラッピングやパーティー用品。",
          instead: "今ある物を使い切ってから買い足しましょう。ギフトバッグは再利用できます。家庭用なら引き出し1つ分の在庫で十分です。",
        },
        {
          title: "10. 単機能の小型家電",
          body: "パスタマシン、ホームベーカリー、炊飯専用の炊飯器、TikTok で見て買った電気圧力鍋。どれも『これで料理が変わる』と思って買いますが、6か月以内に収納行きになることがよくあります。",
          stop: "1つのレシピや流行をきっかけに買う専用家電。",
          instead: "買う前に借りるかレンタルしてみましょう。普通の道具で同じ料理を3回作り、それでも欲しいなら置き場所を与える価値があります。",
        },
      ],
      rulesTitle: "習慣を固定するためのシンプルな2ルール",
      rulesBody: "行動を変えるには意志力より仕組みが必要です。次の2つは、買う瞬間に効くルールです。",
      oneInOneOutHeading: "1つ入れたら1つ出すルール",
      oneInOneOutBody:
        "新しい物を1つ入れたら、同じ種類の物を1つ出します。新しいシャツを買ったら古い1枚を寄付する。新しいフライパンを入れたら古い1つを手放す。目的は罰ではなく、総量に上限をかけることです。『今回は例外で』と思った瞬間に、まず何を手放すかを考えるようになります。",
      twentyTwentyHeading: "20/20ルール",
      twentyTwentyBody:
        "『念のため』で残したり買ったりする物は、20ドル以下で、今いる場所から20分以内に買い直すか借りられるなら持ち続ける必要はありません。The Minimalists で知られるルールで、手放しにくい just in case アイテムに特によく効きます。多くの予備品はこの条件を満たすのに、感情だけで必要に見えているからです。",
      faqTitle: "よくある質問",
      faqs: [
        ["最初に何を買うのをやめればいいですか？", "いちばん摩擦が低く、増える速度が速いカテゴリーから始めてください。衝動買いのネット通販と無料のおまけです。無意識のうちに家へ入ってきやすいので、止めると変化が最も早く見えます。そのあとで、自宅で特にたまりやすいカテゴリーを順に加えましょう。"],
        ["ギフトや、家族が持ち込む物はどうすればいいですか？", "人が何をくれるかはコントロールできませんが、自分がどう扱うかは決められます。ギフトを寄付しても大丈夫です。ギフトの意味は渡された時点で完了していて、物自体を一生持つ義務はありません。親しい人には『今年は物より体験型ギフトがうれしい』と早めに伝えると、入口から減らせます。"],
        ["もう何年もたまった物はどう片付けますか？", "すでに家にある物は断捨離の手順で処理します。このページが扱うのは『入ってくる量』の問題です。新しく入る物を減らしつつ、今ある物も安定して出していく。この2本を同時に回さないと、どちらか片方だけでは続きません。"],
      ],
      relatedTitle: "関連ガイド",
      relatedIntro: "すでに家にある物を片付けたいなら、こちらから部屋別に進められます。",
      relatedLinks: [
      ...
      labels: { stop: "やめる買い物", instead: "代わりにすること" },
    };
  }
  ...
  if (locale === "zh") {
    return {
      ...
      eyebrow: "少杂物的家",
      heroTitle: "10 件该停止买的东西，让家里保持清爽不堆积",
      heroSubtitle:
        "想让家里少堆杂物，多扔的效果会被持续不断的购买抵消。这份清单列出 10 类最容易让家里再次堆满的东西，每一类都给出停止买什么、替代行为是什么。",
      introTitle: "为什么 \"少买\" 比 \"多扔\" 更可持续",
      introBody:
        "整理半天换来的空间，常常几个月之内又被填满。不是你不够努力，而是消费循环没有停下来——每周新的东西仍然进来，而离开的速度跟不上。真正让家里保持清爽，不是在整理的周末，而是在每次按下 \"加入购物车\" 之前那一秒。停止购买 10 类最容易堆积的东西，比再整理一遍要省力得多。",
      itemsTitle: "10 类让家里持续堆积的购买",
      items: [
        {
          title: "1. 便宜的收纳箱",
          body: "买收纳箱常常感觉像在 \"变整齐\"。但便宜的塑料箱真正做的，是让你推迟关于里面那些东西的决定。箱子不是用来装真正在用的东西，而是用来装那些 \"以后再决定\" 的东西。Target、Amazon 大促时一冲动搬回来的箱子，最后装着的往往就是它本来要整理的那堆待定堆，外加一个对不上内容的标签。",
          stop: "促销时 \"以后说不定用得上\" 的塑料收纳箱。",
          instead: "先清空你已经有的箱子。需要被装起来的东西，常常比货架上的收纳箱数量少 30-50%。先整理，再针对留下的东西买对应的收纳。",
        },
        {
          title: "2. 免费赠品和样品",
          body: "免费试用装、活动赠送的托特包、消费满赠的小礼物——这些东西因为不花钱，几乎没有被审视就进了家。但每一件都占地方、都需要某一天决定怎么处理，多数最后躺在一个永远不会被打开的抽屉里。",
          stop: "你不会用的免费香水试用装、不需要的活动托特包、签到送的小本子。",
        ...
        {
          title: "4. 跟潮流买的衣服",
          body: "短命潮流推动了巨大的购物量。但潮流单品的穿着周期越来越短——cottagecore 长裙、Y2K 低腰裤、coastal grandma 毛衣，每一波只穿两次就被衣柜拒收。潮流型衣服比任何衣柜消化得都快，绝大多数一年内进了捐赠袋。",
        ...
        },
        {
          ...
          stop: "任何来自 \"你可能也喜欢\" 推荐位的、打开应用之前不在你购物清单上的东西。",
          instead: "用心愿单取代购物车。先加进去，等 7 天，再回去看那个清单。周二晚上很急的东西，周一早上看常常已经没必要了。",
        },
        {
      ...
      faqs: [
        ...
        ["礼物和别人带进家的东西怎么办？", "你不能控制别人送什么。但可以控制你怎么对待。允许自己捐出礼物——不是不感激，而是礼物的意义在 \"被送出\" 那一刻已经完成，物品本身不必终生绑定。如果是亲近的人，可以提前说 \"今年我想要体验类的礼物\"，避免实物累积。"],
        ["这些年累积的东西怎么办？", "已经在家的东西按整理流程处理；这份清单解决的是入口端的问题，不解决存量。两条线必须同时做：一边减少新进来的，一边稳定地放出已经在家的。只做一边都会失败。"],
      ],
      relatedTitle: "相关阅读",
      relatedIntro: "想看具体房间怎么整理，可以从这些指南开始：",
      relatedLinks: [
