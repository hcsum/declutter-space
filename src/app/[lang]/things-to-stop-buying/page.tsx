...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      introBody:
        "週末に頑張って片付けても、数か月後には元に戻ることがよくあります。努力が足りないのではなく、consumption loop が止まっていないだけです。毎週新しい物が入ってきて、出ていく速度が追いつきません。散らからない家は、片付けの日につくられるのではなく、「カートに追加」を押す直前の判断で守られます。定期的に増えやすい10種類の買い物を止める方が、四半期ごとに大がかりな断捨離をするよりずっと楽です。",
      itemsTitle: "家をまた物で埋める10の買い物カテゴリー",
      items: [
        {
          title: "1. 安い収納ボックス",
          body: "収納用品を買うと、片付けが進んだように感じがちです。けれど安価なプラスチックケースは、実際には中身の判断を先送りしやすくします。ボックスは『使っている物の定位置』ではなく、『あとで考える物の保留箱』になりやすいからです。セールで勢いで買った収納ケースの多くは、結局そのままの maybe pile を押し込んで終わります。",
        ...
        },
        {
          ...
          instead: "カートではなく wishlist を使ってください。いったん追加して7日待ち、そのあとで見直します。火曜の夜に急いで見えた物は、月曜の朝には不要に見えることがよくあります。",
        },
        {
