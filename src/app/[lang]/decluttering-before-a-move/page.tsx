...
function getCopy(locale: string): Copy {
  if (locale === "ja") {
    return {
      ...
      description:
        "後で捨てる物のために引っ越し代を払わないための、引っ越し前の片付けチェックリスト。6〜8週間前から始める持ち物の減らし方、部屋別の進め方、後悔を減らす判断基準をまとめました。",
      eyebrow: "引っ越しと持ち物の整理",
      heroTitle: "引っ越し前の片付け（持ち物を減らすチェックリスト）",
      heroSubtitle:
      ...
      stepsTitle: "部屋別に持ち物を減らす順番",
      stepsIntro:
        "感情が薄く、量が多い場所から始めて、個人的な物へ進みます。どの段階でも、箱詰めの前に「残す／売る・寄付する／処分する」に仕分けます。",
      steps: [
        {
      ...
      faqs: [
        ...
        ["捨てたあと後悔しそうで怖いです。どう判断すればいいですか？", "『私はこれを運んで、開けて、置き場所を作るためにお金と手間をかけたいか？』で考えてください。そして焦って大量処分しないこと。本当に危ないのは、『適当な物の箱』に実は書類や写真が入っていて、そのまま捨てることです。捨てる前にすべての箱を一度開けて中身をざっと見て、出生証明書など重要書類は別にし、期限付きの小さな「保留ボックス」を作ってください。難しい物は判断ガイドも役立ちます。"],
        ["思い出の品や遺品はどうすればいいですか？", "最後に回し、よく代表する少数だけ残して、残りは写真にします。二度と開けない箱のために引っ越し代を払わないことです。やさしく進めたいなら、思い出の品の片付け方や死別後の片付けガイドも参考になります。"],
      ],
      relatedTitle: "関連記事",
      relatedIntro: "引っ越しで物を減らすときに必要なのは、日常の片付けでも使う判断力です。次に読むならこちら:",
      relatedLinks: [
